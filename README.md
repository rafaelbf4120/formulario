...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div id="app-page"
        ...
        <h1 class="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-6 md:mb-8">Lançamento de Corridas</h1>
        ...
        <form id="form-corrida" class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
            ...
            <div>
                ...
                <input type="text" id="motorista" name="motorista" list="motoristas-list" onblur="validateMotorista()"
            ...
            <div>
                <label for="matricula" class="block text-sm font-medium text-gray-700">Matrícula do
                    transportado:</label>
                <input type="text" id="matricula" name="matricula" onblur="autofillTransportado()"
                    onfocus="this.classList.remove('error-border')"
                    class="mt-1 block w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out">
            </div>
            ...
            <div>
                ...
                <input type="text" id="transportado" name="transportado" onblur="autofillMatricula()"
                    onfocus="this.classList.remove('error-border')"
                    class="mt-1 block w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out">
            </div>
            ...
            <div>
                ...
                <input type="text" id="solicitante" name="solicitante" onfocus="this.classList.remove('error-border')"
                    class="mt-1 block w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out">
            </div>
            ...
            <div>
                ...
                <input type="text" id="destino" name="destino" onfocus="this.classList.remove('error-border')"
                    class="mt-1 block w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out">
            </div>
            ...
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" id="valor" name="valor" oninput="formatCurrencyInput(this)"
                        onfocus="this.classList.remove('error-border')"
                        class="block w-full px-3 py-2 pl-9 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                        value="0,00">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative mt-1">
                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">R$</span>
                    <input type="text" id="valor-extra" name="valor-extra" oninput="formatCurrencyInput(this)"
                        onfocus="this.classList.remove('error-border')"
                        class="block w-full px-3 py-2 pl-9 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                        value="0,00">
                </div>
            ...
            <div class="md:col-span-2 flex flex-col md:flex-row justify-between gap-4 mt-4">
                ...
                <button type="button" id="download-csv"
                    class="w-full md:w-1/2 px-6 py-3 bg-green-600 text-white font-bold rounded-lg shadow-lg hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 transition duration-150 ease-in-out">
        ...
        <div class="flex flex-col md:flex-row justify-center gap-4">
            ...
            <button type="button" id="open-motoristas-modal"
                class="px-6 py-3 bg-indigo-600 text-white font-bold rounded-lg shadow-lg hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 transition duration-150 ease-in-out">
    ...
    <script>
        const localStorageKey = 'corridasData';
        const transportadosKey = 'transportadosList';
        const motoristasKey = 'motoristasList';
        ...
        const users = [
            ...
            { username: 'gerente', password: 'senha123' }, // Exemplo de um novo usuário
            { username: 'motorista1', password: 'senha456' } // Outro exemplo
        ];
        ...
        // Carrega a lista de transportados do localStorage ou usa a lista padrão
        let transportadosData = JSON.parse(localStorage.getItem(transportadosKey)) || [
            { matricula: '0001', nome: 'Rafael' },
            { matricula: '0002', nome: 'Marcos' },
        ];

        // Carrega a lista de motoristas do localStorage ou usa a lista padrão
        let motoristasData = JSON.parse(localStorage.getItem(motoristasKey)) || [
            { nome: 'João' },
            { nome: 'Maria' },
        ];
        ...
        function rebuildTransportadosLookups(sortKey = 'nome', sortOrder = 'asc') {
            ...
            localStorage.setItem(transportadosKey, JSON.stringify(transportadosData));
        ...
        function rebuildMotoristasLookups(sortOrder = 'asc') {
            ...
            localStorage.setItem(motoristasKey, JSON.stringify(motoristasData));
        ...
        function renderTransportadosList() {
            ...
            transportadosData.forEach((item, index) => {
                ...
                row.innerHTML = `
                    <td class="p-4"><input type="checkbox" data-index="${index}" class="transportado-checkbox rounded-sm"></td>
        ...
        function renderMotoristasList() {
            ...
            motoristasData.forEach((item, index) => {
                ...
                row.dataset.index = index;
                row.innerHTML = `
                    <td class="p-4"><input type="checkbox" data-index="${index}" class="motorista-checkbox rounded-sm"></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${item.nome}</td>
                `;
                tableBody.appendChild(row);
            });
        ...
        document.getElementById('add-transportado').addEventListener('click', function () {
            ...
            if (newMatricula && newNome) {
                ...
                if (existing) {
                    ...
                    transportadosData.push({ matricula: newMatricula, nome: newNome });
        ...
        document.getElementById('delete-selected-transportados').addEventListener('click', function () {
            ...
            indicesToDelete.forEach(index => transportadosData.splice(index, 1));
            rebuildTransportadosLookups();
            showWarning(`${checkboxes.length} transportados excluídos com sucesso!`);
        });

        document.getElementById('add-motorista').addEventListener('click', function () {
            ...
            if (newNome) {
                ...
                if (existing) {
                    ...
                    motoristasData.push({ nome: newNome });
        ...
        document.getElementById('delete-selected-motoristas').addEventListener('click', function () {
            ...
            const indicesToDelete = Array.from(checkboxes).map(cb => parseInt(cb.dataset.index, 10)).sort((a, b) => b - a);
            indicesToDelete.forEach(index => motoristasData.splice(index, 1));
            rebuildMotoristasLookups();
